...
const researcherOrAdmin: Role[] = ['admin', 'researcher']
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/workflow', component: Workflow, meta: { title: '全流程向导', roles: adminOnly } },
    { path: '/strategy-management', component: StrategyManagement, meta: { title: '策略管理', roles: adminOnly } },
    ...
    { path: '/data-health', component: DataHealth, meta: { title: '数据健康', roles: adminOnly } },
    { path: '/data-sources', component: DataSourceManagement, meta: { title: '数据源管理', roles: adminOnly } },
    { path: '/system-status', component: SystemStatus, meta: { title: '系统状态', roles: adminOnly } },
    { path: '/audit-logs', component: AuditLogs, meta: { title: '操作审计', roles: adminOnly } },
    { path: '/users', component: UserManagement, meta: { title: '用户管理', roles: adminOnly } },
    { path: '/factors', component: Factors, meta: { title: '因子排名' } },
    { path: '/factor-research', component: FactorResearch, meta: { title: '因子研究', roles: researcherOrAdmin } },
    { path: '/portfolio', component: Portfolio, meta: { title: '目标组合' } },
    { path: '/holdings', component: Holdings, meta: { title: '当前持仓', roles: researcherOrAdmin } },
    { path: '/investment-plans', component: InvestmentPlans, meta: { title: '定投计划', roles: researcherOrAdmin } },
    { path: '/risk-rebalance', component: RiskRebalance, meta: { title: '风控调仓', roles: researcherOrAdmin } },
    { path: '/backtest', component: Backtest, meta: { title: '回测', roles: researcherOrAdmin } },
...
router.beforeEach(async (to) => {
  ...
  try {
    ...
    if (allowedRoles && !allowedRoles.includes(normalizeRole(status.role))) {
