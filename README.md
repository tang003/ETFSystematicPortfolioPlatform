...
- 版本：`v0.26.0-broker-style-holdings`
- 阶段：当前持仓体验优化
- 业务能力：完整 ETF 投研链路、严格数据门禁、管理员鉴权、生产部署、自动数据库迁移、备份恢复、独立工作流 worker、外部 Caddy 接入和券商式持仓录入
...
- 券商式持仓录入：按代码、名称、资产类型、持仓数量、现价、成本价录入，自动计算市值、成本、盈亏和权重。
